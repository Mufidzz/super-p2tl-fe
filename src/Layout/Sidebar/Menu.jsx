...
export const MENUITEMS = [
    ...
    {
        menutitle: 'Data',
        menucontent: 'Bank Data, Data DIL',
        Items: [
            {
                title: 'Bank Data', icon: Layers, type: 'link', path: `${process.env.PUBLIC_URL}/data/bank`
            },
            {
                title: 'Data DIL', icon: Layers, type: 'link', path: `${process.env.PUBLIC_URL}/data/dil`
            },
            {
                title: 'Data TO/SO', icon: Layers, type: 'link', path: `${process.env.PUBLIC_URL}/data/to-so`
            },
        ]
    },
    ...
    {
        menutitle: 'Rekap',
        menucontent: 'Rekap Performance, Rekap Temuan',
        Items: [
            // {
            //     title: 'Performance', icon: FileText, type: 'link', path: `${process.env.PUBLIC_URL}/rekap/performance`
            // },
            {
                title: 'Temuan', icon: FileText, type: 'link', path: `${process.env.PUBLIC_URL}/rekap/temuan`
            },
            {
                title: 'Penormalan', icon: FileText, type: 'link', path: `${process.env.PUBLIC_URL}/rekap/penormalan`
            },
        ]
    },
    {
        menutitle: 'Progress',
        menucontent: 'Penormalan',
        Items: [
            {
                title: 'Penugasan TO/SO', icon: Triangle, type: 'link', path: `${process.env.PUBLIC_URL}/progress/penugasan-to-so`
            },
            {
                title: 'Penugasan Temuan', icon: Triangle, type: 'link', path: `${process.env.PUBLIC_URL}/progress/penugasan-temuan`
            },
        ]
    },
    {
        ...
        Items: [
            {
                title: 'Akun', icon: Users, type: 'link', path: `${process.env.PUBLIC_URL}/setting/akun`
            },
            {
                title: 'Setting', icon: Cpu, type: 'link', path: `${process.env.PUBLIC_URL}/setting/default`
            },
        ]
    },
    //
    ...
    //                 { path: `${process.env.PUBLIC_URL}/charts/chartist`, type: 'link', title: 'Chartist Chart' },
    //
    //             ]
    //         },
    //     ]
    ...
    //         { path: `${process.env.PUBLIC_URL}/app/kanban-board`, icon: Monitor, badge: 'badge badge-info mb-0', badgetxt: 'latest', title: 'Kanban Board', type: 'link' },

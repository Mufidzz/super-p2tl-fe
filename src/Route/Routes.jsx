...
import BankData from "../Views/Data/BankData";
import DataDIL from "../Views/Data/DataDIL";
import DataTOSO from "../Views/Data/Data TO-SO";
import ProgressPenugasan from "../Views/Progress/Penugasan-TOSO";
import ProgressPenugasanTemuan from "../Views/Progress/Penugasan-Temuan";
import ProgressPenugasanTOSO from "../Views/Progress/Penugasan-TOSO";
import RekapTemuan from "../Views/Rekap/RekapTemuan";
import RekapPenormalan from "../Views/Rekap/RekapPenormalan";
import RekapPerformance from "../Views/Rekap/RekapPerformance";
...
export const routes = [
        ...
        // data
        { path: `${process.env.PUBLIC_URL}/data/bank`, Component: <BankData /> },
        { path: `${process.env.PUBLIC_URL}/data/to-so`, Component: <DataTOSO /> },
        { path: `${process.env.PUBLIC_URL}/data/dil`, Component: <DataDIL /> },

        // rekap
        { path: `${process.env.PUBLIC_URL}/rekap/performance`, Component: <RekapPerformance /> },
        { path: `${process.env.PUBLIC_URL}/rekap/temuan`, Component: <RekapTemuan /> },
        { path: `${process.env.PUBLIC_URL}/rekap/penormalan`, Component: <RekapPenormalan /> },

        // progress
        { path: `${process.env.PUBLIC_URL}/progress/penugasan-to-so`, Component: <ProgressPenugasanTOSO /> },
        { path: `${process.env.PUBLIC_URL}/progress/penugasan-temuan`, Component: <ProgressPenugasanTemuan /> },
        //
        // //dashboard
        ...
        // { path: `${process.env.PUBLIC_URL}/buttons/flatBtn` , Component: <FlatButton /> },
        // { path: `${process.env.PUBLIC_URL}/buttons/edgeBtn` , Component: <EdgeButton /> },
        // { path: `${process.env.PUBLIC_URL}/buttons/raisedBtn` , Component: <RaisedButton /> },
        ...
        // { path: `${process.env.PUBLIC_URL}/charts/knobChart` , Component: <KnobChart /> },
        //
        // // // Forms
        ...
        // { path: `${process.env.PUBLIC_URL}/form-widget/timepicker` , Component: <Timepicker /> },
        ...
        // { path: `${process.env.PUBLIC_URL}/app/contact-firebase` , Component: <ContactFirebase /> },
        ...
        // { path: `${process.env.PUBLIC_URL}/app/todo-firebase` , Component: <TodoFirebaseContain /> },
        ...
        //
        // //Support Ticket
        // { path: `${process.env.PUBLIC_URL}/app/support-ticket` , Component: <SupportTickitContain /> },
        //
        // //Faq

...
const ListCard = () => {
  ...
  let Fontawesomelist = ['<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-angle-double-right txt-primary m-r-10"></i>Lorem ipsum dolor sit amet'];
  let Iconlist = ['<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="fa fa-caret-right txt-secondary m-r-10"></i>Lorem ipsum dolor sit amet'];
  let Themfylist = ['<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet', '<i class="icofont icofont-ui-rate-add txt-success m-r-10"></i>Lorem ipsum dolor sit amet'];;

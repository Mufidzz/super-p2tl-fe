                    ...
                    <div className={`collapse ${isShow ? 'show' : ''}`} id="collapseicon2" aria-labelledby="collapseicon2" data-parent="#accordion">
                        <CardBody className="post-about">
                            ...
                            <div className="social-network theme-form">
                                ...
                                <Btn attrBtn={{ className: 'btn social-btn btn-fb mb-2 text-center', color: 'transperent' }} ><i className="fa fa-facebook m-r-5"></i>Facebook</Btn>
                                <Btn attrBtn={{ className: 'btn social-btn btn-twitter mb-2 text-center', color: 'transperent' }} ><i className="fa fa-twitter m-r-5"></i>Twitter</Btn>
                                <Btn attrBtn={{ className: 'btn social-btn btn-google text-center', color: 'transperent' }} ><i className="fa fa-dribbble m-r-5"></i>Dribbble</Btn>
                            </div>
                        </CardBody>
                    </div>
                </Card>

                            ...
                            <div className="email-app-sidebar">
                                ...
                                <UL attrUL={{ className: 'simple-list nav main-menu ', role: 'tablist' }}>
                                    <LI attrLI={{ className: 'nav-item' }}>
                                        <a className="btn-primary btn-block btn-mail w-100" id="pills-darkhome-tab" data-bs-toggle="pill" href="#pills-darkhome" role="tab" aria-controls="pills-darkhome" aria-selected="true">
